...
GameStage* GameStage::s_app = nullptr;
...
void GameStage::LoadContexts()
{
    ...
    struct threadwrapper
    {
        static unsigned int WINAPI thunk(LPVOID lpParameter)
        {
            ...
            GameStage::Get()->WorkerThread(parameter->threadIndex);
            return 0;
        }
    };
...
void GameStage::WorkerThread(int threadIndex)
{
...
void GameStage::SetCommonPipelineState(ID3D12GraphicsCommandList* pCommandList)
{
