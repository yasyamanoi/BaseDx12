...
namespace basedx12 {
	...
	vector<MapData> g_StageData1
	{
		...
		{ CharaType::WallSquare, Float3(7.0,7.0,1.0), Float3(0.0), Quat(), Float3(-20.0f,-7.0f,0.0f) },
		...
		{ CharaType::WallSquare, Float3(3.0,3.0,1.0), Float3(0.0), Quat(), Float3(0.0f,4.0f,0.0f) },
		{ CharaType::WallSquare, Float3(3.0,3.0,1.0), Float3(0.0), Quat(), Float3(-15.0f,-9.0f,0.0f) },
		{ CharaType::MoveSquare, Float3(5.0,1.0,1.0), Float3(0.0), Quat(), Float3(8.0f,0.0f,0.0f) },
